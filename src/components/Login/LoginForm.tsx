			...
			<div className="w-full max-w-md border border-gray-300 shadow-xl rounded-2xl p-6 bg-white relative animate-fadeIn">
				...
				<div className="mt-4 flex gap-4">
					<Link 
						...
						className="w-1/2 flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 py-3 px-4 rounded-lg cursor-pointer transition-all">
				...
				<p
					...
					Do not have the account ? register the user
				</p>
			</div>
